export const projects_list = [
    {
        ...
        title: 'Job Portal',
        year: 'June 2026 - July',
        description: `Developed a full-stack job portal using React, FastAPI, SQLAlchemy, 
        and PostgreSQL, featuring RESTful APIs for job, application, and company management,
    ...
    },
    {
        ...
        description: `Supported an e-commerce platform with product, cart, and order workflows, 
    ...
    },
    {
        ...
        year: 'January 2025',
        description: `Developed a responsive biryani restaurant website using React.js
